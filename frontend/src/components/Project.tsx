  ...
  return (
    ...
    >
      <div
        ...
        dark:bg-gray-800 hover:bg-gray-100 border-2 border-gray-300
        dark:border-gray-500  shadow-sm shadow-gray-300 dark:shadow-gray-600
      ...
      >
        ...
        >
          <h5 
            className="mt-2 mb-2 text-2xl font-bold tracking-tight
            dark:text-white"
          >
            {props.title}
          </h5>
