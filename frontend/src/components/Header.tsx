...
export default function Header({theme, updateTheme, toggleNavBar, isPhoneNavOpen, currentVisibleSection}:props) {
    ...
    >
      ...
      >
        ...
        <div
          ...
          id="mobile-menu-2"
        >
          <Nav visible={currentVisibleSection} toggleNavBar={toggleNavBar} />
        </div>
      </nav>
